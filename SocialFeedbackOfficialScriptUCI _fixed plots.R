...
# facebook.plot <- ggplot(news_facebook, 
#                         aes(x=Hour, y=log(Facebook), group=Hour)) + 
#                         geom_boxplot() + 
#                         ggtitle("Facebook") + 
#                         ylab("Shares (log)") + 
...
ggplot(news_facebook)+
  geom_step(aes(news_facebook$Hour,
           news_facebook$Facebook),
           color = 'red')
ggplot(news_googleplus)+
  geom_step(aes(news_googleplus$Hour,
                news_googleplus$GooglePlus),
            color = 'red')
ggplot(news_linkedin)+
  geom_step(aes(news_linkedin$Hour,
                news_linkedin$LinkedIn),
            color = 'red')
